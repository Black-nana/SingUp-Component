        ...
        <div className='grid place-items-center w-full max-md:absolute h-screen'>
          <div className='form-container w-3/4 grid gap-4 h-3/4'>
            <h1 className='font-bold text-3xl flex justify-items-center justify-center gap-2 max-md:h-14'>
              <span className='border-b-4 border-green-600'>Create</span> Account
              <RiAccountBoxFill className='text-green-600 text-4xl group' />
            </h1>
            <form onSubmit={handleSubmit(onSubmit)}>
              <div className={`input-group relative ${errors.fullName ? 'border-red-500' : ''}`}>
                ...
                <div className='w-full'>
                  ...
                  />
                  {errors.fullName && (
                    <p className='text-sm text-red-500 m-0 p-0'>{errors.fullName.message}</p>
                  )}
                </div>
              </div>
              <div className={`input-group relative ${errors.email ? 'border-red-500' : ''}`}>
                ...
                <div className='w-full'>
                  ...
                  />
                  {errors.email && (
                    <p className='text-sm text-red-500 m-0 p-0'>{errors.email.message}</p>
                  )}
                </div>
              </div>
              <div className={`input-group relative ${errors.password ? 'border-red-500' : ''}`}>
                ...
                <div className='w-full'>
                  ...
                  />
                  {errors.password && (
                    <p className='text-sm text-red-500 m-0 p-0'>{errors.password.message}</p>
                  )}
                </div>
              </div>
              <button
